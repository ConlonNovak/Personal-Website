  ...
  render() {
    ...
    return (
      <div className={classes.root}>
        <IconButton className={classNames(classes.icon, 'fab fa-facebook-f fa-inverse')} href="https://www.facebook.com/Conlon.Novak"/>
        <IconButton className={classNames(classes.icon, 'fab fa-twitter fa-inverse')} href="https://twitter.com/Conlon_Novak"/>
        <IconButton className={classNames(classes.icon, 'fab fa-linkedin-in fa-inverse')} href="https://www.linkedin.com/in/conlon-novak/"/>
        <IconButton className={classNames(classes.icon, 'fab fa-instagram fa-inverse fa-lg')} href="https://instagram.com/conlonnovak/"/>
